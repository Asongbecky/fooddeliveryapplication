...
CREATE TABLE `delivery_boy` (
  `delivery_boy_id` int(222) NOT NULL,
  `username` varchar(222) NOT NULL,
  `password` varchar(222) NOT NULL,
  `email` varchar(222) NOT NULL,
  `code` varchar(222) NOT NULL,
...
INSERT INTO `delivery_boy` (`delivery_boy_id`, `username`, `password`, `email`, `code`, `date`) VALUES
(1, 'delivery_boy', 'CAC29D7A34687EB14B37068EE4708E7B', 'delivery_boy@mail.com', '', '2022-05-27 13:21:52');
