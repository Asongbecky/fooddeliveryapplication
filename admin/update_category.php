...
<body class="fix-header">
    ...
    <div id="main-wrapper">
        <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/icn.png"  width="36" height="36" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>Njinuwo Leslly</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:02 AM</span>
                                                </div>
                                            </a>
                                        </div>
                                    </li>
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer"> © 2023 - Online Food Ordering System | By AB</footer>
